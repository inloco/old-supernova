  ...
  _createClass(Pill, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "label",
        { className: "sn-pills__label", onClick: this.props.onClick },
        _react2.default.createElement("input", _extends({ type: "radio" }, this.getRadioProps())),
        _react2.default.createElement(
          "span",
          { className: "sn-pills__label--content" },
          this.props.label
        )
      );
    }
